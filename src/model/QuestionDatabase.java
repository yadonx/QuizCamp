...
public class QuestionDatabase implements Serializable {
    ...
    private void addCategories() {
        ...
        djurOchNatur.addQuestion(new Question("Vilken är den normala kroppstemperaturen\n för en hund?",
        ...
        kroppOchKnopp.addQuestion(new Question("Hur många gram natrium har en\n fullvuxen människa i sin kropp?",
                "100 g", "1 g", "1000 g", "10 g"));
        kroppOchKnopp.addQuestion(new Question("Vilka alternativ är INTE namnet\n på en typ av blodkärl?",
                "Alveol", "Kapillär", "Ven", "Artär"));
        kroppOchKnopp.addQuestion(new Question("Vad heter den del av blindtarmen\n som ibland kan bli inflammerad?",
        ...
        musikOchHits.addQuestion(new Question("Vad hette Wolfgang Mozarts violinist\n och tonsättare till far?",
                "Leopold", "Bach", "Amadeus", "Leonardo"));
        musikOchHits.addQuestion(new Question("Metalbandet Bathory sägs vara det band\n som skapade subgenren " +
                "'Black Metal'. Men vilken svensk filmregissör\n har varit med i bandet?",
        ...
        dataOchTVSpel.addQuestion(new Question("Vem av följande är INTE en medlem i \nKoopa-familjen i Super Mario's värld?",
                "Mandy Koopa", "Ludqig von Koopa", "Bowser Jr", "Lemmy Koopa"));
        dataOchTVSpel.addQuestion(new Question("Vilket företag står \nbakom \"Street Fighter\"-serien?",
                "Capcom", "Tecmo", "Konami", "Namco"));
        dataOchTVSpel.addQuestion(new Question("Vilken typ av spel är \nSonic the Hedgehog 2 som släpptes " +
        ...
        bockerOchOrd.addQuestion(new Question("Vad kallas formen \"rödare\" i förhållande\n till \"röd\"?",
        ...
        bockerOchOrd.addQuestion(new Question("Vilken av följande böcker \när INTE en bok av David Pelzer?",
